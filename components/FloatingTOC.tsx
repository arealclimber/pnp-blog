...
export default function FloatingTOC({ toc }: FloatingTOCProps) {
  ...
  return (
    <nav className="fixed right-0 top-48 z-50 max-h-[80vh] max-w-[50vw] overflow-y-auto border border-gray-200 bg-white p-2 opacity-90 shadow-lg dark:border-gray-700 dark:bg-gray-900 md:max-w-[25vw]">
