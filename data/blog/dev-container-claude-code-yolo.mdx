...
- Install the extension by Anysphere (Note: If you install the wrong one, VS Code will prompt you to install the correct version when you open the dev container)
